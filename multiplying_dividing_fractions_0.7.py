# Alani S., Multipling and Dividing Fractions, 05/06/2019, version 0.7
...
new_denomintor = denominator0 * denominator1
...
#  This is where the division of the fration will start.
pie = 22 / 7
print(pie)
