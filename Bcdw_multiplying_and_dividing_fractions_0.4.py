...
print(Fot this program, I need to know the numerator and denominator for both fractions.\n" )
...
new_denominator = denominator0 * denominator

print("The new fraction is",new_numerator,"/",denominator1,".\n
